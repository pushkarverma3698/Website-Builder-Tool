...
6. **"Do you have any special requests, custom features, or on-demand requirements?"** — Free text. Use this to adapt the design or functionality beyond the standard preset.
...
- **Palette:** Deep Space `#000000` (Primary/Dark Phase), Off-White `#F8F9FA` (Light Phase), Near Black `#202124` (Text/Light Phase), Aurora Glow `Multi-color Gradient` (Accent)
- **Typography:** Headings: "Google Sans Flex" (tight tracking, authoritative). Body: "Google Sans Text". Data/Micro-copy: Small-caps with wide tracking.
...
0. **Reference Check:** If a reference website URL was provided, visit it to analyze the content, data, and context (strictly ignore its design) before proceeding with the build.
